...
/***************************/
typedef void *el_type;
typedef void (*Print_func)(el_type);
typedef int (*Comp_func)(el_type, el_type);
typedef void (*Free_data)(el_type);
typedef el_type (*Copy_func)(el_type);
typedef bool (*Is_last)(el_type);
/***************************/
